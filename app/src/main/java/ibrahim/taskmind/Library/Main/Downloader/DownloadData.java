...
public class DownloadData extends AsyncTask<String, Integer, String> {
    ...
    public DownloadData(Context context, ProgressDialog mProgressDialog) {
        this.context = context;
    ...
    protected String doInBackground(String... sUrl) {
        ...
        try {
            ...
            output = new FileOutputStream("/MindValley/"+HelperMethods.getFileNameFromURL(sUrl[0]));
    ...
    protected void onPostExecute(String result) {
        ...
        if (result != null)
            ...
            {
                Log.e("QP","File Downloaded : "+result);
            Toast.makeText(context, "File downloaded", Toast.LENGTH_SHORT).show();
            }
    }


} // class of DownloadData
